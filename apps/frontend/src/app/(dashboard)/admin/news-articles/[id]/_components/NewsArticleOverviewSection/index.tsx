...
// `components/(common)/news-articles-details-page/NewsArticleOverviewSection`.
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          {news?.published_at && (
            <div className="bg-muted rounded-lg p-4">
              ...
              <div className="text-foreground text-sm">
                {new Date(String(news.published_at)).toLocaleDateString(
                  "en-US",
                  {
                    year: "numeric",
                    month: "long",
          ...
          {news?.edited_at && (
            <div className="bg-muted rounded-lg p-4">
              ...
              <div className="text-foreground text-sm">
                {new Date(String(news.edited_at)).toLocaleDateString(
                  "en-US",
                  {
                    year: "numeric",
                    month: "long",
