...
import { Eye, ImageIcon, Play, Youtube } from "lucide-react";
import React from "react";

// Ported from apps/adminpanel's
// `components/(common)/news-articles-details-page/NewsArticleMediaSection`.
// `Image` (lucide-react) was renamed to its `ImageIcon` alias: eslint's
// jsx-a11y/alt-text rule pattern-matches the JSX tag name `Image` (assuming
// next/image) and false-flags this decorative icon otherwise.
