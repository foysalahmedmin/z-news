...
// `components/(common)/news-articles-details-page/NewsArticleWorkflowSection`.
      ...
      <div className="bg-muted/20 flex flex-col items-center justify-center space-y-4 rounded-xl border-2 border-dashed py-12">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground max-w-sm text-sm">
            This article isn&apos;t currently in the editorial pipeline. Start
            a workflow to assign reviewers and editors.
          </p>
        </div>
        <Button
          onClick={() =>
      ...
      <div className="bg-primary/5 border-primary/20 flex items-center justify-between rounded-lg border p-4">
        <div>
          ...
          <p className="text-muted-foreground text-xs">
            Original deadline:{" "}
            {workflow.deadline
              ? new Date(String(workflow.deadline)).toLocaleDateString()
              : "N/A"}
          </p>
        </div>
        <Badge
                  ...
                  <div className="text-muted-foreground flex items-center gap-4 text-xs">
                    ...
                    {stage.updated_at && (
                      <span className="flex items-center gap-1">
                        ...
                        {new Date(String(stage.updated_at)).toLocaleString()}
                      </span>
                    )}
                  </div>
