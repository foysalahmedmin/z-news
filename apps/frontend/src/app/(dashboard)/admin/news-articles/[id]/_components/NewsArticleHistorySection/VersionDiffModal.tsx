...
import type { TArticleVersion, TNews } from "@/types/admin-news.type";
import { Eye, FileText, Type } from "lucide-react";
import type React from "react";

// Ported from apps/adminpanel's
// `components/(common)/news-articles-details-page/NewsArticleHistorySection/VersionDiffModal`.
// apps/frontend's `ModalBackdrop` wraps `ModalContent` as a container (it's
// not a bare self-closing overlay like apps/adminpanel's `<Modal.Backdrop />`
// sibling) — same pattern already used by apps/frontend's own `useAlert`.
