...
import type { TCategory, TStatus } from "@/types/admin-category.type";
import { Calendar, Eye, EyeOff, Star, Tag } from "lucide-react";
import React from "react";

// Ported from apps/adminpanel's
// `components/(common)/categories-details-page/CategoryInfoSection`.
        ...
        <div className="flex-shrink-0">
          {category?.thumbnail ? (
            ...
            <div className="bg-muted flex size-24 items-center justify-center rounded-md">
              <Icon className="size-12" name={category?.icon || "blocks"} />
            </div>
          )}
        </div>
