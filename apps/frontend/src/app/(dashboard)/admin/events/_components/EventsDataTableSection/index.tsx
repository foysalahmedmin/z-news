...
// `components/(common)/events-page/EventsDataTableSection`. The original
// also accepted `breadcrumbs` and `onAdd` props, but neither was actually
// read inside the component body — dropped here as dead props.
  ...
  const columns: TColumn<TEvent>[] = [
    {
      ...
      cell: ({ cell }) => (
        <span>
          <Icon name={typeof cell === "string" ? cell : ""} />
        </span>
      ),
    },
