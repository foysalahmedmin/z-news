...
// TODO: This component depends on @tanstack/react-query, axios, and
// react-toastify, none of which are installed in apps/frontend yet (no
// QueryClientProvider is wired up either — see src/providers). These are
// needed for the file-listing query, upload/delete mutations, and toast
// notifications below. Leaving the imports/usages as ported from
// apps/adminpanel until that infra is added in a later migration phase.
...
const FileSelectionModal = ({
  ...
  return (
    <Modal isOpen={isOpen} setIsOpen={setIsOpen} size="xl" className={className}>
      <ModalBackdrop>
        <ModalContent className="flex max-h-[90vh] w-full max-w-6xl flex-col">
          {/* Header */}
          <ModalHeader>
