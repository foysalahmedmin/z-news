...
// `components/(user)/profile-page/ProfileOverviewSection`. Fixed the
// source's "supper-admin" typo, which never matched the backend's actual
// "super-admin" role and silently hid the writer statistics block for
// super-admins (see apps/frontend's admin-menu-items.ts port for the same
// fix elsewhere).
