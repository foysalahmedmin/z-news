...
// news-articles-mutation-page/ImageUpload/index.tsx. Not wired into the
// main NewsArticleForm (the source's Add/Edit pages never rendered this
// component either -- it's only consumed by SEOSection, which is likewise
// unused there), kept here for parity with the 9 ported subsections.
// `name` can address a path outside the strict `NewsFormData` shape
// (`seo.image`), so field access below is loosely typed same as source.
