...
// Ported from apps/adminpanel's news-articles-mutation-page/TemplateSelector.
// Compound `Card.Content` -> flat `CardContent`. Only rendered on the Add
// form (see NewsArticleForm/index.tsx), matching the source where the Edit
// page never imported this component.
