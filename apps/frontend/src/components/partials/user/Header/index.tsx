...
import Search from "@/components/partials/admin/Header/Search";
...
// Header for the plain-signed-in-user dashboard shell (`/user/*`). Mirrors
// admin/Header/index.tsx's structure exactly. Search is fully generic (no
// admin dependency at all), so it's reused directly rather than forked;
// Notification and Profile are the user-scoped forks alongside this file.
