...
import MenuItem from "@/components/partials/admin/Sidebar/MenuItem";
...
// Sidebar for the plain-signed-in-user dashboard shell (`/user/*`). Mirrors
// admin/Sidebar/index.tsx's structure exactly, swapping in useUserMenu() for
// the menu data. MenuItem is fully generic (only depends on useSetting for a
// UI-density boolean), so it's reused directly from the admin partial rather
// than forked.
